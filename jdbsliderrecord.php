    ...
    <div class="h-screen flex-grow-1 overflow-y-lg-auto">
                        ...
                        <div class="col-sm-6 col-12 text-sm-end">
                            <div class="mx-n1">
                                ...
                                <a href="#" class="btn d-inline-flex btn-sm btn-primary mx-1">
                                    ...
                                    <span><a href="jdbslider.php"> Create</a></span>
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <tbody> 
            ...
            <tr>  <td><?php echo $rows['id']; ?></td>
                ...
                <td><button class="btn  btn-info"><a href="jdbslideredit.php?id=<?php echo $rows['id'];  ?>" style="color: white;"> Edit</a></button> 

              <button class="btn  btn-primary"><a href="jdbsliderview.php?id=<?php echo $rows['id'];  ?>" style="color: white;"> View</a></button>

                <button class="btn  btn-danger"><a href="jdbsliderdelet.php?id=<?php echo $rows['id'];  ?>" style="color: white;"> Delete</a></button> </td> 
