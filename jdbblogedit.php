...
$id = $_GET['id'];
  $sql = "select * from jdbblog where id=$id"; 
...
<div class="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary">
  ...
  <section class="panel important">
    ...
    <?php 
        ...
        ?>
      <form action="jdbbloginsedit.php?id=<?php echo $values['id'] ?>" method="post" enctype="multipart/form-data">
        <div class="twothirds">
           <input type="hidden" name="id"  value="<?php echo $values['id'] ?>" size="40"/><br/><br/>
          Blog title:<br/>
          <input type="text" name="title"  value="<?php echo $values['title'] ?>" size="40"/><br/>
          description:<br/>
          <input type="text" name="description"  value="<?php echo $values['description'] ?>" size="40"/><br/><br/>
           Image:<br/>
          <input type="file" name="image" size="40"/><br/><br/>
           <input type="text" name="image_old" value="<?php echo $values['image'] ?>"  size="40"/><br/><br/> 
          <img src="jdbimg/<?php echo $values['image'];?>" height="100px" width="auto"><br/>    
         <br/>  
        </div>
