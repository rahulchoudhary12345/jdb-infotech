                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-6 col-12 text-sm-end">
                            <div class="mx-n1">
                                ...
                                <a href="jdbcard2.php" class="btn d-inline-flex btn-sm btn-primary mx-1">
                                    <span class=" pe-2">
        ...
        <tbody> 
            ...
            <tr>  <td><?php echo $rows['id']; ?></td>
              ...
              <td><?php echo $rows['description']; ?></td>
                ...
                <td><button class="btn  btn-info"><a href="jdbcard2edit.php?id=<?php echo $rows['id'];  ?>" style="color: white;"> Edit</a></button> 

              <button class="btn  btn-primary"><a href="jdbcard2view.php?id=<?php echo $rows['id'];  ?>" style="color: white;"> View</a></button>

                <button class="btn  btn-danger"><a href="jdbcard2delet.php?id=<?php echo $rows['id'];  ?>" style="color: white;"> Delete</a></button> </td> 
